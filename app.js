document.addEventListener('DOMContentLoaded', async () => {
  ...
  const players = [
    ...
    { id:'kento-momota',    name:'Kento Momota',     country:'Japan 🇯🇵',
      ...
      back:'Rebuilt his career with discipline after a crash.' },
    ...
    { id:'pv-sindhu',       name:'P. V. Sindhu',     country:'India 🇮🇳',
      ...
      back:'Trained by Gopichand from age 16.' },
    ...
    { id:'anders-antonsen', name:'Anders Antonsen',  country:'Denmark 🇩🇰',
      style:'Tactical, accurate shot-making',        legacy:'European Champ 2018; World silver 2019',
    ...
    { id:'jonatan-christie',name:'Jonatan Christie', country:'Indonesia 🇮🇩',
      ...
      back:'PB Djarum prodigy with charisma.' },
    ...
    { id:'akane-yamaguchi', name:'Akane Yamaguchi',  country:'Japan 🇯🇵',
      ...
      back:'One of the fastest movers ever.' },
    ...
    { id:'srikanth-kidambi',name:'Srikanth Kidambi', country:'India 🇮🇳',
      style:'Aggressive attack, deceptive net',      legacy:'World Champ 2019; Superseries titles',
      back:'Relentless circuit runner to top-10.' },
    ...
    { id:'kodai-naraoka',   name:'Kodai Naraoka',    country:'Japan 🇯🇵',
      style:'Balanced offense, steady defense',      legacy:'International titles; rising star',
    ...
    { id:'michelle-li',     name:'Michelle Li',      country:'Canada 🇨🇦',
      ...
      back:'Broke Canada’s badminton drought.' },
    ...
    { id:'chou-tien-chen',  name:'Chou Tien-Chen',   country:'Chinese Taipei 🇹🇼',
      ...
      back:'Crafty Taipei youth circuit prodigy.' }
  ];
  ...
  const workouts = {
    beginner:{
      ...
      Wednesday:['5×30s side shuffles','3×12 deadlifts','5 min hopscotch'],
    ...
    intermediate:{
      Monday:   ['15 min interval run','5×40m sprints','5 min cross-court clears'],
      Tuesday:  ['4×8 goblet squats','4×10 rows','3×20 bicycle twists'],
      Wednesday:['3×8 box jumps','5 min ladder drill','3×15 lateral bounds'],
      Thursday: ['4×8 pull-ups','4×10 dips','3×30s side-plank'],
      Friday:   ['10 min tempo run','3×20 fly-runs','30 drives'],
      Saturday: ['30 min multi-shuttle','15 min tactical drills','10 min stretch']
    },
    advanced:{
      Monday:   ['20 min intervals','6×50m shuttle sprints','4×8 eight-corner footwork'],
      ...
      Friday:   ['10 min run + 5×20 fly-runs','30 flick return drills','30 smash drills'],
      Saturday: ['Best-of-3 match play','15 min cool-down & stretch']
    }
  };
  ...
  // 4) Film Analysis + Rule-Based Tips
  ...
  async function analyzeWithRules(frames=5) {
    ...
    for(let i=1;i<=frames;i++){
      ...
      if(poses[0]) all.push(extractMetrics(poses[0]));
    }
    const avg={};
    all.forEach(m=>{ for(let k in m) avg[k]=(avg[k]||0)+m[k]/all.length; });
    const tips=[];
